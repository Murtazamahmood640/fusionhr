...
const AssignTasks = () => {
  ...
  useEffect(() => {
    const getCreatedProjects = async () => {
      try {
        const response = await axios.get('https://a-khuhro-abidipro.mdbgo.io/api/project/created', {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (editingIndex !== null) {
        ...
        await axios.put(`https://a-khuhro-abidipro.mdbgo.io/api/assigned-tasks/${projectId}`, formData);
        const updatedProjects = [...projects];
        updatedProjects[editingIndex] = { ...formData, _id: projectId };
        setProjects(updatedProjects);
        toast.success("Task updated successfully");
      } else {
        const response = await axios.post("https://a-khuhro-abidipro.mdbgo.io/api/create-tasks", formData);
