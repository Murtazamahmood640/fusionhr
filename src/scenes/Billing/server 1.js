...
app.post("/checkout", async (req, res) => {
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: "https://arshia-abidipro.mdbgo.io/HomePage",
      cancel_url: "https://arshia-abidipro.mdbgo.io/404",
    })
  } catch (err) {
    console.log(err);
...
app.post('/create-checkout-session', async (req, res) => {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: 'https://arshia-abidipro.mdbgo.io/success',
      cancel_url: 'https://arshia-abidipro.mdbgo.io/fail',
    });
